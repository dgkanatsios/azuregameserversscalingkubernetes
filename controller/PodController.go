...
func NewPodController(client *kubernetes.Clientset, dgsclient *dgsclientset.Clientset,
	dgsInformer informerdgs.DedicatedGameServerInformer, podInformer informercorev1.PodInformer,
	nodeInformer informercorev1.NodeInformer) *PodController {
...
func (c *PodController) syncHandler(key string) error {
	...
	dgsToUpdate.Status.PreviousPodState = dgsToUpdate.Status.PodState
