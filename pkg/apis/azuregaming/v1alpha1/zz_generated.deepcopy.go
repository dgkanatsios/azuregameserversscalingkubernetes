...
func (in *DGSActivePlayersAutoScalerDetails) DeepCopyInto(out *DGSActivePlayersAutoScalerDetails) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DGSActivePlayersAutoScalerDetails.
func (in *DGSActivePlayersAutoScalerDetails) DeepCopy() *DGSActivePlayersAutoScalerDetails {
	if in == nil {
		return nil
	}
	out := new(DGSActivePlayersAutoScalerDetails)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DedicatedGameServerCollectionSpec) DeepCopyInto(out *DedicatedGameServerCollectionSpec) {
	*out = *in
	...
	if in.DGSActivePlayersAutoScalerDetails != nil {
		in, out := &in.DGSActivePlayersAutoScalerDetails, &out.DGSActivePlayersAutoScalerDetails
		*out = new(DGSActivePlayersAutoScalerDetails)
		**out = **in
	}
	return
