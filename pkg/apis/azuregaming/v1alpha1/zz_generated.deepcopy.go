...
func (in *DedicatedGameServerSpec) DeepCopyInto(out *DedicatedGameServerSpec) {
	*out = *in
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
		*out = make([]PortInfoExtended, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PortInfoExtended) DeepCopyInto(out *PortInfoExtended) {
	*out = *in
	out.PortInfo = in.PortInfo
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PortInfoExtended.
func (in *PortInfoExtended) DeepCopy() *PortInfoExtended {
	if in == nil {
		return nil
	}
	out := new(PortInfoExtended)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PortRegistry) DeepCopyInto(out *PortRegistry) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PortRegistry.
func (in *PortRegistry) DeepCopy() *PortRegistry {
	if in == nil {
		return nil
	}
	out := new(PortRegistry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *PortRegistry) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PortRegistryList) DeepCopyInto(out *PortRegistryList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]PortRegistry, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PortRegistryList.
func (in *PortRegistryList) DeepCopy() *PortRegistryList {
	if in == nil {
		return nil
	}
	out := new(PortRegistryList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *PortRegistryList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PortRegistrySpec) DeepCopyInto(out *PortRegistrySpec) {
	*out = *in
	if in.Ports != nil {
		in, out := &in.Ports, &out.Ports
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PortRegistrySpec.
func (in *PortRegistrySpec) DeepCopy() *PortRegistrySpec {
	if in == nil {
		return nil
	}
	out := new(PortRegistrySpec)
	in.DeepCopyInto(out)
	return out
}
