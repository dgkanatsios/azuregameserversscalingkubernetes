...
func (in *DedicatedGameServerCollectionSpec) DeepCopyInto(out *DedicatedGameServerCollectionSpec) {
	*out = *in
	...
	if in.PodAutoScalerDetails != nil {
		in, out := &in.PodAutoScalerDetails, &out.PodAutoScalerDetails
		*out = new(DedicatedGameServerPodAutoScalerDetails)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DedicatedGameServerPodAutoScalerDetails) DeepCopyInto(out *DedicatedGameServerPodAutoScalerDetails) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DedicatedGameServerPodAutoScalerDetails.
func (in *DedicatedGameServerPodAutoScalerDetails) DeepCopy() *DedicatedGameServerPodAutoScalerDetails {
	if in == nil {
		return nil
	}
	out := new(DedicatedGameServerPodAutoScalerDetails)
