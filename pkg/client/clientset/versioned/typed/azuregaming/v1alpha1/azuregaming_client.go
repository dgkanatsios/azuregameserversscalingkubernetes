...
import (
	...
	"github.com/dgkanatsios/azuregameserversscalingkubernetes/pkg/client/clientset/versioned/scheme"
...
func NewForConfig(c *rest.Config) (*AzuregamingV1alpha1Client, error) {
	...
	return &AzuregamingV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AzuregamingV1alpha1Client for the given config and
...
func New(c rest.Interface) *AzuregamingV1alpha1Client {
	return &AzuregamingV1alpha1Client{c}
}
