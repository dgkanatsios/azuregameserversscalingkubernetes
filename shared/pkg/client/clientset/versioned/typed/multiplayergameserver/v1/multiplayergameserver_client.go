...
func NewForConfig(c *rest.Config) (*AzureV1Client, error) {
	config := *c
	...
	return &AzureV1Client{client}, nil
}

// NewForConfigOrDie creates a new AzureV1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *AzureV1Client {
...
// New creates a new AzureV1Client for the given RESTClient.
func New(c rest.Interface) *AzureV1Client {
	return &AzureV1Client{c}
}
...
func (c *AzureV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
